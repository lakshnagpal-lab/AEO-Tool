...
with head2:
    ...
    with col_text:
        ...
        st.markdown("<p style='font-size: 1.1rem; color: #64748b; margin-top: 5px;'>Does your website build trust with AI Answer Engines? Our analyzer checks for information density, semantic structure, and entity-first optimization.</p>", unsafe_allow_html=True)
